        ...
        <main className="pt-20">
          ...
          <Breadcrumb
            items={[
              ...
              { name: "Workshop-Catering", href: "#", current: true }
            ]}
          />

          {/* Back to Blog */}
          <nav className="container mx-auto max-w-4xl px-4 py-4">
            <Link to="/catering/blog" className="inline-flex items-center gap-2 text-muted-foreground hover:text-primary transition-colors">
                ...
                <div className="prose prose-lg max-w-none">
                  ...
                  <div className="space-y-12">
                    ...
                    <section>
                      ...
                      <div className="text-muted-foreground space-y-4">
                        ...
                        <p>Das richtige Essen kann helfen:</p>
                    ...
                    <section>
                      ...
                      <div className="space-y-4 mt-6">
                        {[
                          { title: "Fingerfood statt Tellergerichte", desc: "Niemand will in der Pause mit Messer und Gabel hantieren. Lieber was, das man mit einer Hand essen kann." },
                          { title: "Vorher fragen, wer was isst", desc: "Vegan, halal, Allergien – klärt das vorher. Nichts ist blöder als wenn jemand nichts essen kann." },
                          { title: "Genug Zeit einplanen", desc: "Das beste Catering bringt nichts, wenn alle in 10 Minuten essen müssen. Mindestens 30 Minuten für Mittag." },
                          { title: "Das Buffet zugänglich aufstellen", desc: "Nicht in die Ecke quetschen. Stellt es so hin, dass Leute drumherum stehen und quatschen können." },
                          { title: "Nicht zu viel bestellen", desc: "Besser einmal nachfragen als hinterher die Hälfte wegschmeißen." }
                        ].map((tip, index) => (
                    ...
                    <div className="space-y-6">
                      <div className="p-6 bg-card border border-border/50 rounded-lg">
                        <h3 className="text-xl font-bold text-foreground mb-2">
                          Wie viel kostet Workshop-Catering?
                        </h3>
                        <p className="text-muted-foreground">
                          Das hängt davon ab, wie viele Leute dabei sind und was ihr wollt. Ab etwa 20-25 € pro Person für einen ganzen Tag mit Vormittags-Snacks, Mittag und Nachmittags-Boost.
                        </p>
                      </div>
                      ...
                      <div className="p-6 bg-card border border-border/50 rounded-lg">
                        ...
                        <p className="text-muted-foreground">
                          Ideal sind 3-5 Tage. Bei größeren Events gerne früher. Aber wir haben auch schon was kurzfristig hinbekommen – einfach fragen.
                        </p>
                      </div>

                      <div className="p-6 bg-card border border-border/50 rounded-lg">
                        <h3 className="text-xl font-bold text-foreground mb-2">
                          Baut ihr das auch auf?
                        </h3>
                        <p className="text-muted-foreground">
                          Können wir machen. Wir kommen, bauen das Buffet auf, machen alles hübsch – und räumen auf Wunsch auch wieder ab.
                        </p>
                      </div>
                    </div>
                  </section>
                  ...
                  <section className="mt-16 text-center p-8 md:p-12 bg-card border-2 border-primary/20 rounded-lg shadow-lg">
                    <h2 className="text-2xl md:text-3xl font-bold mb-4 text-foreground">
                      Nächster Workshop steht an?
                    </h2>
                    <p className="text-lg mb-6 text-muted-foreground">
                      Erzählt uns, was ihr plant – wir machen euch ein passendes Angebot.
                    </p>
                    <Link to="/catering?scrollTo=contact">
                      <Button size="lg" className="gap-2 w-full sm:w-auto">
                        Workshop-Catering anfragen
                      </Button>
                    </Link>
                  </section>
                </div>
