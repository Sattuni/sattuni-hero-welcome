  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 touch-manipulation",
  {
    variants: {
      variant: {
        ...
        hero: "bg-gradient-warm text-primary-foreground hover:shadow-warm transform hover:scale-105 active:scale-100 transition-all duration-300 font-semibold text-lg",
        "hero-secondary": "border-2 border-primary/30 bg-background/80 backdrop-blur-sm text-foreground hover:bg-primary/10 hover:border-primary/50 active:bg-primary/20 transition-all duration-300 font-medium",
      },
      size: {
        default: "h-11 px-4 py-2 min-h-[44px]",
        sm: "h-10 rounded-md px-3 min-h-[44px]",
        lg: "h-12 rounded-md px-8 min-h-[44px]",
        xl: "h-14 rounded-lg px-10 py-4 min-h-[44px]",
